...
export default buildModule("MyToken20251009095404Module", (m) => {
  // Deploy the MyToken20251009095404 contract with constructor parameters:
  ...
  const myToken = m.contract("MyToken20251009095404", [
    tokenName,
    tokenSymbol,
    initialSupply,
    initialOwner
